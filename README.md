...
Snímek dokumentuje reakci systému na změnu uživatelského vstupu na hodnotu 2 (binárně 0010), což odpovídá aktivaci přepínače sw(1). Vzhledem k implementaci pomocí konstrukce if-elsif vykazuje tento přepínač vysokou prioritu. Dojde k okamžité změně frekvence generování pulzů ce_out.
